...
var note_scene: PackedScene = preload("res://scenes/minigames/cutting/note.tscn")
var beat_scene: PackedScene = preload("res://scenes/minigames/cutting/beat.tscn")
var measure_scene: PackedScene = preload("res://scenes/minigames/cutting/measure.tscn")
