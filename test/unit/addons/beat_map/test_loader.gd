...
func test_if_test_song_exist():
	...
	var test_song_path = "res://music/test_song/"
	assert_true(
	...
	assert_true(
		ResourceLoader.exists(test_song_path + "cutting-1.beat"),
		"'cutting-1.beat' should exist at path: " + test_song_path
	)
...
func test_get_resource_script_class():
	var loader = BeatMapLoader.new()
	var classname = loader._get_resource_script_class("res://music/test_song/fishing-1.beat")
	assert_eq(classname, "beat_map.gd", "Resource script class should be 'beat_map.gd'")


func test_get_resource_type():
	var loader = BeatMapLoader.new()
	var resource_type = loader._get_resource_type("res://music/test_song/fishing-1.beat")
	assert_eq(resource_type, "BeatMap", "Resource type should be 'BeatMap'")


func test_load():
	var loader = BeatMapLoader.new()
	var path = "res://music/test_song/fishing-1.beat"
